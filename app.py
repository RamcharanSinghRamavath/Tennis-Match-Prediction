...
def about_page():
    ...
    st.markdown("""
    <div align="center">
        <a href="https://github.com/RamcharanSinghRamavath" target="_blank">
            <img src="https://ghchart.rshah.org/00b4d8/RamcharanSinghRamavath" alt="GitHub Heatmap" width="600px"/>
        </a>
    </div>
    """, unsafe_allow_html=True)
    ...
    - ✉️ **Email**: work.ramcharansinghramavath@gmail.com 
